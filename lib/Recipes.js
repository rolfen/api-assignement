...
/*
 * All added recipies get passed through this function. If recipe contains no ID, try to generate it automatically (auto-increment)
 * If recipe has an ID and it is not unique, the refuse to append it.
